...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    drilldownDataTop = [
      {
        dataGroupId: "ShipInfo",
        data: [
          ["DGPS", updateDataObject("DGPS", refs.GLL.value, refs.ALLGLL.value)],
          ["GYRO", updateDataObject("GYRO", refs.GGA.value, refs.ALLGGA.value)],
          ["ANEMOMETER", updateDataObject("ANEMOMETER", refs.RMC.value, refs.ALLRMC.value)],
          ["RADAR", updateDataObject("RADAR", refs.VTG.value, refs.ALLVTG.value)],
          ["AIS", updateDataObject("AIS", refs.ZDA.value, refs.ALLZDA.value)],
          ["ECDIS", updateDataObject("ECDIS", refs.GSV.value, refs.ALLGSV.value)],
          ["AUTOPILOT", updateDataObject("AUTOPILOT", refs.GSA.value, refs.ALLGSA.value)],
          ["SPEEDLOG", updateDataObject("SPEEDLOG", refs.RMC.value, refs.ALLRMC.value)],
          ["CanThrottle", updateDataObject("CanThrottle", refs.VTG.value, refs.ALLVTG.value)],
          ["AUTOPILOTCONTACT", updateDataObject("AUTOPILOTCONTACT", refs.ZDA.value, refs.ALLZDA.value)],
          ["NO.1ENGINE", updateDataObject("NO.1ENGINE", refs.GSV.value, refs.ALLGSV.value)],
          ["NO.2ENGINE", updateDataObject("NO.2ENGINE", refs.GSA.value, refs.ALLGSA.value)],
        ],
      },
      {
        dataGroupId: "KassInfo",
        data: [
