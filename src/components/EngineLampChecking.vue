...
const data = [
  ...
  { key:  9,
     name:  "Low Fuel Level"},
  { key:  10,
     name:  "Engine Oil Over Heat"},
  { key:  11,
     name:  "Main connector Removed"},
  { key:  12,
     name:  "High Exhaust Gas Temperature"},
  { key:  13,
     name:  "Low Boost Air Pressure"},
  { key:  14,
     name:  "High Boost Air Pressure"},
  { key:  15,
     name:  "Engine Shutdown"},
  { key:  16,
     name:  "Low Engine Speed"},
];
